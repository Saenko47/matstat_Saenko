...
У цій лабораторній роботі було засвоєно принципи створення динамічних
документів у стилі literate programming із використанням R, RStudio та R
Markdown. Було розглянуто процес генерації даних, їхньої обробки та
візуалізації, а також способи експортування результатів у різні формати
(HTML, PDF, Word, GitHub-friendly Markdown).

Практична частина роботи продемонструвала, як поєднувати код, аналітику
та оформлення в єдиному документі, забезпечуючи високу читабельність і
відтворюваність результатів. Використання пакетів knitr, ggplot2, rio,
dplyr, stargazer, xtable дозволило оптимізувати процес обробки даних та
зробити звіт структурованим, наочним і зручним для подальшого
використання.

Робота показала, що грамотне застосування R Markdown суттєво спрощує
створення аналітичних документів, дозволяє організувати дослідження у
формі самодокументованого коду та забезпечує професійний рівень подання
результатів.
